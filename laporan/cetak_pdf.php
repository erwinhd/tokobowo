...
switch ($_GET['menu']) {
	...
	case 'transaksi': @$inc="cetak_transaksi.php"; @$nama="Laporan Transaksi - ".$bulaninitext." ".$thn.".pdf"; break;
	case 'transaksi_harian': @$inc="cetak_transaksi_harian.php"; @$nama="Laporan Transaksi Harian - Tanggal $a $bln $c.pdf"; break;
	...
	case 'lap_laris': @$inc="cetak_laris.php"; @$nama="Laporan Barang Laris.pdf"; break;
	default: break;
}
