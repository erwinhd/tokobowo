					...
					<div class="col-md-4 pull-right" style="margin-right:-5px;">
						<div class="input-group">
							<div class="input-group-btn">
								...
								<a href="../laporan/cetak_exceltransaksi.php?menu=transaksi&bln=<?php echo $bulanini; ?>&thn=<?php echo $tahunini; ?>" target="_blank" class="btn btn-success"><div class="glyphicon glyphicon-floppy-save"></div>&nbsp;Simpan Excel</a>
							</div>
						</div>
					</div>
