			...
			<tbody>
				...
				?>
					<tr>
						...
						<td align="center" style="border:1px solid black"><?php echo $data['barang']; ?></td>
						<td align="right" style="border:1px solid black"><?php echo number_format($data['harga'],0,'','.'); ?></td>
						<td align="right" style="border:1px solid black"><?php echo number_format($data['banyak'],0,'','.'); ?></td>
						<td align="right" style="border:1px solid black"><?php echo number_format($data['total'],0,'','.'); ?></td>
					</tr>
				<?php } } ?>
			</tbody>
		</table>
